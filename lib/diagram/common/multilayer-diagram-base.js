...
class MultilayerDiagramBase extends DiagramBase {
  ...
  getGraphDataViaREST(params) {
    const snake2Camel = (str) => str.toLowerCase().replace(/_./g, (s) => s.charAt(1).toUpperCase())
  ...
  restURI(graphName, params) {
    ...
    const baseUri = this.apiParam.restURIBase + `/api/graph/${graphName}/${params.modelFile}`
