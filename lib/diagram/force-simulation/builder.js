...
class ForceSimulationDiagramBuilder extends DiagramBase {
   ...
   */
  _makeInfoTables() {
    const tableContainerSelection = this.diagramContainerSelection.append('div').attr('class', 'info-tables')
  ...
  _makeNodeInfoTable(tableContainer) {
    this.nodeInfoTableSelection = tableContainer.append('table').attr('class', 'node-info-table')
  ...
  _makeTermPointInfoTable(tableContainer) {
    /** @type {Selection} */
    this.termPointInfoTableSelection = tableContainer.append('table').attr('class', 'tp-info-table')
    this.termPointInfoTableSelection.append('tr').append('th').html('Term Point')
  }
